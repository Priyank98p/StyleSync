    ...
    <div className="my-10">
      <div className="text-center py-8 text-5xl">
        ...
        <p className="w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta porro quam praesentium repudiandae, fugit fugiat nobis veniam ducimus laboriosam deserunt!
        </p>
      </div>
